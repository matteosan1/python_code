...
frames = FPS / 12
strips = [
    SpriteStripAnim('cavallo_nero_sheet_v2.bmp', (0,0,40,156), 4, 1, True, frames),
    SpriteStripAnim('cavallo_marrone_sheet_v2.bmp', (0,0,40,156), 4, 1, True, frames),
    SpriteStripAnim('cavallo_bianco_sheet_v2.bmp', (0,0,40,156), 4, 1, True, frames),
]
black = Color('black')
