...
'''
class TdPPE(App):
    title = 'Tempo di Palio PE'
    #icon = 'icon.png'   FIXME da aggiungere
    ...
    def build(self):
        ...
        print '\nTempo di Palio Phone Edition v%s  Copyright (C) 2014 MatteoSoftware' % VERSION
        ...
        # FIXME inizializzazione del gioco (con i dati che arrivano dal server
